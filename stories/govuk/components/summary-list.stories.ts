...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: "Official \`summary-list\` examples from govuk-frontend fixtures.",
      },
    },
  },
};
...
export const Default: Story = {
  name: "default",
  render: () => `<dl class="govuk-summary-list">
...
export const NoBorder: Story = {
  name: "no-border",
  render: () => `<dl class="govuk-summary-list govuk-summary-list--no-border">
  <div class="govuk-summary-list__row">
    <dt class="govuk-summary-list__key">
      Name
    </dt>
...
export const AsASummaryCardWithATextHeader: Story = {
  ...
  render: () => `<div class="govuk-summary-card">
